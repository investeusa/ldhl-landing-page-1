...
import headline from "@/images/headline4.png";
...
export default function Home() {
  ...
  const [userDelay, setUserDelay] = useState(1000 * 490); // 490
          ...
          <section className="bg-primary pt-5 pb-10 mask1 bg-[url('/images/bg-1-plain.svg')] bg-no-repeat bg-bottom bg-contain">
            ...
            <div className='justify-center items-center content-center relative z-0'>
              <div className="divide-y divide-gray-300/50 md:max-w-md md:ml-56 flex z-0">
                <div id="vid_656531cf0eb2920009dc4d2a" >
                  <div id="thumb_656531cf0eb2920009dc4d2a" role="status" className='flex justify-center items-center p-5 z-0'>
                  ...
                  <div id="backdrop_656531cf0eb2920009dc4d2a"></div>
                </div>
                <Script type="text/javascript" id="scr_656531cf0eb2920009dc4d2a">var s=document.createElement(`script`);s.src=`https://scripts.converteai.net/dc18b5f5-d9cd-4d50-b62e-13e5bdae39b4/players/656531cf0eb2920009dc4d2a/player.js`,s.async=!0,document.head.appendChild(s);</Script>
              </div>
            </div>
            <div className="flex justify-center py-7">
              {isButtonVisible && (
                ...
                >
                  clique aqui! Quero tratar a Herpes Labial!
                </Button>
              )}
            </div>
          </section>
              ...
              <section className="mb-5 md:px-16">
                ...
                <div className="flex justify-center">
                  <Button
                    ...
                    onClick={() => setTestButton(true)}
                  >
                    Quero tratar a Herpes Labial hoje
                  </Button>
                  {/* <Button
                    type="primary"
                    href={`${URL_TICTO}${utmParams}`}
