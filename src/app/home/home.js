...
export default function Home() {
  ...
  const [userDelay, setUserDelay] = useState(1000 * 680); // 490
          ...
          <section className="bg-primary pt-5 pb-10 mask1 bg-[url('/images/bg-1-plain.svg')] bg-no-repeat bg-bottom bg-contain">
            ...
            <div className='justify-center items-center content-center relative z-0'>
              <div className="divide-y divide-gray-300/50 m-5 flex z-0">
                <div id="vid_65731cfe44d6ff0008a76fbf" >
                  <div id="thumb_65731cfe44d6ff0008a76fbf" role="status" className='flex justify-center items-center p-5 z-0'>
                  ...
                  <div id="backdrop_65731cfe44d6ff0008a76fbf"></div>
                </div>
                <Script type="text/javascript" id="scr_65731cfe44d6ff0008a76fbf">var s=document.createElement(`script`);s.src=`https://scripts.converteai.net/dc18b5f5-d9cd-4d50-b62e-13e5bdae39b4/players/65731cfe44d6ff0008a76fbf/player.js`,s.async=!0,document.head.appendChild(s);</Script>
              </div>
            </div>
