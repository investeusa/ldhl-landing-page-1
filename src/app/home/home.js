          ...
          <section className="bg-primary pt-5 pb-10 mask1 bg-[url('/images/bg-1-plain.svg')] bg-no-repeat bg-bottom bg-contain">
            ...
            <div className='justify-center items-center content-center relative z-0'>
              <div className="divide-y divide-gray-300/50 m-5 flex z-0">
                <div id="vid_657273dcb126a00009d011bf" >
                  <div id="thumb_657273dcb126a00009d011bf" role="status" className='flex justify-center items-center p-5 z-0'>
                  ...
                  <div id="backdrop_657273dcb126a00009d011bf"></div>
                </div>
                <Script type="text/javascript" id="scr_657273dcb126a00009d011bf">var s=document.createElement(`script`);s.src=`https://scripts.converteai.net/dc18b5f5-d9cd-4d50-b62e-13e5bdae39b4/players/657273dcb126a00009d011bf/player.js`,s.async=!0,document.head.appendChild(s);</Script>
              </div>
            </div>
